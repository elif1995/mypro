 ...
 import {faHtml5, faGithub, faJs, faPython, faReact, faCss3, faBootstrap, faJava, faNodeJs, faNode, faNpm } from '@fortawesome/free-brands-svg-icons'

 function skills (){
    
     return(
         <div id='skills' className="skillsOut">
            ...
            <div  className="skillsIcons">
                ...
                <div className='box-6'> <FontAwesomeIcon  icon={faJava} size="2x"></FontAwesomeIcon></div>
                <div className='box-6'> <FontAwesomeIcon  icon={faNode} size="2x"></FontAwesomeIcon></div>
                <div className='box-6'> <FontAwesomeIcon  icon={faNpm} size="2x"></FontAwesomeIcon></div>
